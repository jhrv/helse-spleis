...
internal class SøknadArbeidsgiverE2ETest : AbstractEndToEndTest() {
    ...
    fun `avslutter uferdig forlengelseperiode som bare strekkes inn i helg`() {
        ...
        assertTilstander(3.vedtaksperiode, START, MOTTATT_SYKMELDING_UFERDIG_FORLENGELSE, AVVENTER_INNTEKTSMELDING_UFERDIG_FORLENGELSE, AVSLUTTET_UTEN_UTBETALING)
    }
    ...
    fun `bare ferie - etter tilbakevennende sykdom`() {
        ...
        assertForventetFeil(
            nå = { assertTilstander(2.vedtaksperiode, START, MOTTATT_SYKMELDING_FERDIG_GAP, AVVENTER_SØKNAD_FERDIG_GAP, AVVENTER_HISTORIKK) },
            ønsket = { assertTilstander(2.vedtaksperiode, START, MOTTATT_SYKMELDING_FERDIG_GAP, AVVENTER_SØKNAD_FERDIG_GAP, AVSLUTTET_UTEN_UTBETALING) }
        )
    }

...
internal class TrekkPerioderTilbake : AbstractEndToEndTest() {
    ...
    fun `Tre arbeidsgivere med påminnelser i tilfeldig rekkefølge - blir behandlet i riktig rekkefølge når vi trekker periodene tilbake`() {
        tilGodkjenning(1.januar, 31.januar, "a1", "a2", inntekterBlock = {
        ...
        håndterInntektsmelding(listOf(1.januar til 16.januar), beregnetInntekt = 20000.månedlig, orgnummer = "a3")
        ...
        assertSisteTilstand(1.vedtaksperiode, AVVENTER_HISTORIKK, "a3")

...
internal class RevurderTidslinjeTest : AbstractEndToEndTest() {
    ...
    fun `annullering etter revurdering  med utbetaling feilet`() {
        ...
        håndterSøknad(Sykdom(29.januar, 26.februar, 100.prosent))

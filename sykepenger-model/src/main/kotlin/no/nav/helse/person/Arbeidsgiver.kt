...
internal class Arbeidsgiver private constructor(
    ...
    internal companion object {
        ...
        internal fun Iterable<Arbeidsgiver>.gjenopptaBehandling(aktivitetslogg: IAktivitetslogg) {
            if (nåværendeVedtaksperioder(IKKE_FERDIG_UTBETALT).isNotEmpty()) return
    ...
    internal fun triggeRevurdering(første: Vedtaksperiode, hendelse: IAktivitetslogg) {
        håndter(hendelse) { triggeRevurdering(hendelse, første) }
        vedtaksperioder.lastOrNull(IKKE_FERDIG_REVURDERT)?.startRevurdering(hendelse)
    }
